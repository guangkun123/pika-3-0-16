...
class BlackWidow {
 public:
  ...
  int64_t db_size_last_time = 0;
  int64_t key_compact_status = 0;
  //int64_t db_compact_old_last_time = 0;
  int64_t db_size = 0;
  int64_t table_reader_usage = 0;
  void db_compact_old_files();

  void DealSlowKey(std::vector<std::string> argv);
  std::map<std::string, DataType> mapCommand = {
